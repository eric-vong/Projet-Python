...
todrop = ['nom_quartier','id_quartier','min','max','epoque','meuble_txt','geometry']
...
#On voit que les 3 dernières variables de l'ACP sont inutiles (contribution de 5%), on peut prendre 7 composantes principales
